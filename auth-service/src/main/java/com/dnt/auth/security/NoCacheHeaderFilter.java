 ...
 * de redirect generadas por Spring Security (por ejemplo, el 302 a /web/login
 * cuando no hay token), que es precisamente la respuesta que un navegador
 * podria cachear y reproducir despues de haber iniciado sesion.
 */
@Component
